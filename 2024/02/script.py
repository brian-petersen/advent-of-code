...
def is_report_safe(report):
    ...
    for i in range(0, len(report)-1):
        ...
        if is_ascending and not current < next:
            return False

        if not is_ascending and not current > next:
            return False
...
#         reports = parse_reports(file)
#
#     # for r in reports:
#     #     print(r)
#     #     print(is_report_safe(r))
#
#     safe_count = [r for r in reports if is_report_safe(r)]
#     print(len(safe_count))
...
def is_report_safe2(report):
    ...
    for i in range(len(report)):
        one_missing = report[:i] + report[i+1:]
        if is_report_safe(one_missing):
            return True
...
if __name__ == '__main__':
    ...
    # for r in reports:
    #     print(r)
    #     print(is_report_safe2(r))

    safe_count = [r for r in reports if is_report_safe2(r)]
    print(len(safe_count))
