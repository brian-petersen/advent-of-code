...
# 1-3 digit numbers. For instance, mul(44,46) multiplies 44 by 46 to
...
#         raw = file.read()
#
#     factors = parse_multiplies(raw)
#     result = sum([a * b for (a, b) in factors])
#
#     print(result)
...
# The other mul instructions function normally, including the one
# at the end that gets re-enabled by a do() instruction.
#
...
if __name__ == '__main__':
    ...
    factors = parse_multiplies(''.join(filtered))
    result = sum([a * b for (a, b) in factors])
